...
public class QikberryOTPSmsGatewayImpl extends SmsClient {
	...
	public SmsResponse send(NotificationTemplateConfigDTO templateConfig, String mobileNumber, String content) throws Exception {
		...
		try {
			...
			rootJSON.put("service", config.get("qikberry.props.type"));
			rootJSON.put("message", content);
//			if (StringUtil.isNotNull(templateConfig.getNotificationSMSConfig().getEntityCode())) {
//				rootJSON.put("entity_id", templateConfig.getNotificationSMSConfig().getEntityCode());
//			}
//			if (StringUtil.isNotNull(templateConfig.getNotificationSMSConfig().getHeaderDltCode())) {
//				rootJSON.put("header_id", templateConfig.getNotificationSMSConfig().getHeaderDltCode());
//			}
//			if (StringUtil.isNotNull(templateConfig.getTemplateDltCode())) {
...
//			}
			...
			try {
				...
				httpPost.addHeader("Authorization", config.get("qikberry.props.otp.key"));
