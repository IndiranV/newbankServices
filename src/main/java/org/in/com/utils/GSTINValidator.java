...
public class GSTINValidator {
	...
	public static StateEM getState(String gstin) {
		String stateId = "0";
		if (validGSTIN(gstin)) {
			char[] gstinChar = gstin.toCharArray();
			stateId = gstinChar[0] + "" + gstinChar[1];
		}
		return StateEM.getStateEMGstID(Integer.valueOf(stateId));
	}
}
